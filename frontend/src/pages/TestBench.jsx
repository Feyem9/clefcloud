...
const TestBench = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="bg-surface-container-lowest shadow-ambient rounded-2xl shadow-ambient p-8 ">
                <h1 className="text-3xl font-bold text-on-surface font-display mb-6 bg-gradient-to-r from-primary-600 to-orange-500 bg-clip-text text-transparent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-4  rounded-xl bg-gray-50/50 dark:bg-gray-900/20">
                            <AudioPlayer src={testAudioUrl} />
                        </div>
                        <ul className="text-sm text-outline-variant list-disc pl-5 space-y-1">
                    ...
                    <div className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full bg-gradient-to-br from-primary to-primary-container text-on-primary hover:opacity-90 transition-all text-on-primary font-bold py-3 rounded-xl shadow-ambient transition-all active:scale-95 flex items-center justify-center gap-2"
                        >
