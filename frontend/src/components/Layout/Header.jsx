      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-2 z-50" onClick={closeMobileMenu}>
            ...
            <span className="text-2xl font-bold text-on-surface font-display">Amitkumar</span>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-6">
              ...
              <>
                ...
                {isAdmin && (
                  <>
                    ...
                    <Link to="/admin" className="text-amber-600 dark:text-amber-400 hover:text-amber-700 transition font-bold active:scale-95">
                      Admin
                    </Link>
                  </>
                )}
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors active:scale-90"
              title={isDarkMode ? 'Mode clair' : 'Mode sombre'}
            >
              {isDarkMode ? (
                <svg className="w-6 h-6 text-yellow-500 transform transition-transform duration-500 rotate-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
              ) : (
                <svg className="w-6 h-6 text-gray-700 dark:text-gray-300 transform transition-transform duration-500 rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {isAdmin && (
                        <>
                          <Link
                            ...
                            className="flex items-center space-x-3 p-4 rounded-xl hover:bg-gray-50 transition-colors group"
                          >
                            <svg className="w-6 h-6 text-outline-variant group-hover:text-amber-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span className="font-medium text-gray-700 group-hover:text-amber-600 transition-colors">Admin</span>
                          </Link>
                          <Link
                            to="/upload"
                            onClick={closeMobileMenu}
