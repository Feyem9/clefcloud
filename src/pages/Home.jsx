...
const Home = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-blue-600 bg-opacity-5 text-white rounded-2xl shadow-2xl p-12 mb-12">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-cyan-50 rounded-xl shadow-md p-8 text-center hover:shadow-xl hover:scale-105 transition-all border border-cyan-100">
          ...
          <div className="bg-blue-50 rounded-xl shadow-md p-8 text-center hover:shadow-xl hover:scale-105 transition-all border border-blue-100">
          ...
          <div className="bg-green-50 rounded-xl shadow-md p-8 text-center hover:shadow-xl hover:scale-105 transition-all border border-green-100">
      ...
      <div className="bg-yellow-50 rounded-xl shadow-lg p-10 mb-12 border border-yellow-200">
      ...
      {/* CTA Section */}
      {!currentUser && (
        <div className="bg-primary-100 rounded-xl p-10 text-center shadow-lg border border-primary-200">
