  ...
  return (
    <div className="min-h-[calc(100vh-80px)] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex items-center justify-center bg-gray-50/50 dark:bg-gray-950/50">
      ...
      <div className="max-w-3xl w-full mx-auto relative z-10">
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-2xl rounded-3xl shadow-2xl p-8 sm:p-12 border border-white/40 dark:border-gray-700/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6 sm:p-8 border border-gray-100 dark:border-gray-700/50 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2 group">
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 group-focus-within:text-primary-600 transition-colors">Titre de l'œuvre *</label>
                  <input type="text" name="title" required value={formData.title} onChange={handleChange}
                    className="w-full px-5 py-3.5 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-4 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all shadow-sm placeholder-gray-400"
                    placeholder="Ex: Ave Maria, Halleluya..." />
                </div>

                <div className="group">
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 group-focus-within:text-primary-600 transition-colors">Compositeur</label>
                ...
                <div className="group">
                  <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 group-focus-within:text-primary-600 transition-colors">Catégorie</label>
                  <div className="relative">
                    <select name="category" value={formData.category} onChange={handleChange}
                      className="w-full px-5 py-3.5 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-4 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all shadow-sm appearance-none cursor-pointer">
            ...
            {/* Section Fichiers */}
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6 sm:p-8 border border-gray-100 dark:border-gray-700/50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative group flex flex-col items-center justify-center p-8 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl hover:border-primary-500 dark:hover:border-primary-400 transition-all duration-300 bg-white/50 dark:bg-gray-800/80 hover:bg-primary-50/50 dark:hover:bg-primary-900/20 text-center overflow-hidden min-h-[160px]">
                  ...
                  <div className="w-14 h-14 rounded-full bg-primary-100 dark:bg-primary-900/50 flex items-center justify-center group-hover:scale-110 group-hover:bg-primary-200 transition-all duration-300 mb-3 shadow-sm">
                    <svg className="w-6 h-6 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                  </div>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Partition (PDF/Img) <span className="text-red-500">*</span></p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Glissez ou cliquez</p>

                  {file && (
                    <div className="absolute inset-x-0 bottom-0 bg-primary-500/10 backdrop-blur-md p-2 border-t border-primary-500/20">
                      <p className="text-xs font-semibold text-primary-700 dark:text-primary-300 truncate px-4 flex justify-center items-center gap-1">
                ...
                <div className="relative group flex flex-col items-center justify-center p-8 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl hover:border-orange-500 dark:hover:border-orange-400 transition-all duration-300 bg-white/50 dark:bg-gray-800/80 hover:bg-orange-50/50 dark:hover:bg-orange-900/20 text-center overflow-hidden min-h-[160px]">
                  ...
                  <div className="w-14 h-14 rounded-full bg-orange-100 dark:bg-orange-900/50 flex items-center justify-center group-hover:scale-110 group-hover:bg-orange-200 transition-all duration-300 mb-3 shadow-sm">
                  ...
                  <p className="text-sm font-bold text-gray-900 dark:text-white">Audio (MP3) <span className="text-gray-400 font-normal ml-1">Optionnel</span></p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Glissez ou cliquez</p>
              ...
              <div className="relative z-20">
                {audioPreviewUrl && (
                  <div className="mt-6 p-4 bg-white dark:bg-gray-800 rounded-xl border border-orange-100 dark:border-orange-900/30 shadow-sm relative z-20">
            ...
            <button type="submit" disabled={loading}
              className="w-full relative group overflow-hidden bg-gradient-to-r from-primary-600 to-orange-500 text-white font-bold py-4 sm:py-5 rounded-2xl shadow-xl hover:shadow-primary-500/40 transition-all duration-300 active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100 mt-8">
